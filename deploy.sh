...
sudo apt-get install -y python3.8 python3.8-venv python3-pip docker.io docker-compose

# Create project directory
mkdir -p /home/aitechnotech/amused
cd /home/aitechnotech/amused
...
[Service]
User=aitechnotech
WorkingDirectory=/home/aitechnotech/amused
Environment="PATH=/home/aitechnotech/amused/venv/bin"
ExecStart=/home/aitechnotech/amused/venv/bin/uvicorn api.main:app --host 0.0.0.0 --port 8000
